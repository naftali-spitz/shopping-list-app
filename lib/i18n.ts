...
export const appCopy = {
  he: {
    ...
    categories: { chooseCategory: "בחר קטגוריה", addCategoryPlaceholder: "הוסף קטגוריה", emptyCategory: "אין מוצרים בקטגוריה", editCategory: "עריכת קטגוריה", editCategoryDescription: "שנה שם קטגוריה בצורה בטוחה.", categoryName: "שם קטגוריה", deleteCategory: "מחק קטגוריה" },
  ...
  en: {
    ...
    categories: { chooseCategory: "Choose category", addCategoryPlaceholder: "Add category", emptyCategory: "No products in this category", editCategory: "Edit category", editCategoryDescription: "Safely rename this category.", categoryName: "Category name", deleteCategory: "Delete category" },
